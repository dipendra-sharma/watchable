...
### Changed
- Removed USAGE.md and TEST_CASES.md (documentation cleanup)

### Documentation
- Removed benchmark comparison table with other libraries from README

## [6.0.1] - 2025-12-12

### Documentation
- Fixed version in README (`^5.0.0` → `^6.0.0`)
- Updated README to reflect v6.0.0 changes: replaced deep equality section with `identical()` comparison explanation
- Updated benchmarks table and "Why Switch" section
